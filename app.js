...
function showEndGamePopup(score) {
  ...
  playAgainButton.removeEventListener('click', playAgainListener);  // Remove any previous listeners
  playAgainButton.addEventListener('click', playAgainListener);  // Add fresh listener
  ...
  function playAgainListener() {
    ...
    try {
      ...
      const txHash = sendMandatoryTx();  // Execute your transaction function

      // Wait for the transaction to be confirmed
      const receipt = waitForTransactionConfirmation(txHash);
